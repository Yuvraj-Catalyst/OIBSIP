...
CREATE TABLE `studenttable` (
  ...
  `CourseName` set('BCA','MCA','B-Tech','M-Tech','B.A','M.A','Bsc-It') DEFAULT NULL,
  `BranchName` set('IT','Management','Sport','Digital Club') DEFAULT NULL,
...
-- Dump completed on 2023-11-18  2:01:50
