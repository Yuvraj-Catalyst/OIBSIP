        ...
        loginbtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(db.validateLogin(username,password,userType)){
                    int selection = JOptionPane.showConfirmDialog(frame1,"Login Successfull","Information",
                    ...
                    if(selection == JOptionPane.YES_OPTION){
                        ...
                        if(userType.equals("Admin")){
                            ...
                            LocalUserMainPage lump = new LocalUserMainPage();
                            lump.localUserMainPage(username,userType);
                        }
                    }
